  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      ...
      if(_imc >= 18.5 && _imc <= 25){
        ...
        _IMCModelo = IMCModelo(imc: _imc, esNormal: false, resultado: "Estás medio desnutrido");
      }else{
        _IMCModelo = IMCModelo(imc: _imc, esNormal: false, resultado: "Estás bien desnutrido");
      }
    });
